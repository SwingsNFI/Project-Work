...
namespace OrHorApp
{
        ...
        where Parent : new()
    {
        ...
        /// <summary>
        /// Fired when the value changes, even the value is the same
        /// </summary>
        ...
        /// <summary>
        /// The method is called when any attached property of this type is changed, even the value is the same
        /// </summary>
        /// <param name="sender">The UI element that this property was changed for</param>
        /// <param name="e">The arguments for this event</param>
